...
export const bankDetailsEmail = (booking, hotel, bankDetails) => {
  return {
    subject: 'Bank Transfer Details - Complete Your Payment',
    html: `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ${emailHeader('Bank Transfer Details', 'Complete your payment using the details below', '#10b981 0%, #059669 100%')}
            <div class="content">
              <p>Dear ${booking.userName},</p>
              <p>Thank you for choosing bank transfer as your payment method. Please find below our bank details to complete your payment.</p>
              ...
              <div style="background: #d1fae5; padding: 20px; border-left: 4px solid #10b981; border-radius: 8px; margin: 25px 0;">
                <h2 style="margin-top: 0; color: #047857; font-size: 20px;">Bank Transfer Details</h2>
                <div style="background: white; padding: 15px; border-radius: 6px; margin-top: 15px;">
                  <div style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                    <span style="font-weight: 600; color: #047857;">Bank Name:</span>
                    <span style="float: right; font-weight: bold;">${bankDetails.bankName}</span>
                  </div>
                  <div style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                    <span style="font-weight: 600; color: #047857;">Account Name:</span>
                    <span style="float: right; font-weight: bold;">${bankDetails.accountName}</span>
                  </div>
                  <div style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                    <span style="font-weight: 600; color: #047857;">Account Number:</span>
                    <span style="float: right; font-weight: bold; font-size: 18px;">${bankDetails.accountNumber}</span>
                  </div>
                  ${bankDetails.branchCode ? `<div style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
                    <span style="font-weight: 600; color: #047857;">Branch Code:</span>
                    <span style="float: right; font-weight: bold;">${bankDetails.branchCode}</span>
                  </div>` : ''}
                  ${bankDetails.swiftCode ? `<div style="padding: 10px 0;">
                    <span style="font-weight: 600; color: #047857;">SWIFT Code:</span>
                    <span style="float: right; font-weight: bold;">${bankDetails.swiftCode}</span>
                  </div>` : ''}
                </div>
              </div>

              <div class="info-box">
                <h3 style="margin-top: 0; color: #1f2937;">Payment Instructions</h3>
                <ul>
                  <li>Transfer exactly <strong>$${booking.totalPrice}</strong> to the account above</li>
                  <li>Use your <strong>Booking ID: ${booking._id}</strong> as the payment reference</li>
                  <li>Keep your payment receipt/proof of transfer</li>
                  <li>Send the payment receipt to <a href="mailto:payments@nonsatravels.com" style="color: #10b981;">payments@nonsatravels.com</a></li>
                  <li>Your booking will be confirmed within 24 hours after payment verification</li>
                </ul>
                ${bankDetails.additionalInfo ? `<p style="margin-top: 15px; padding: 10px; background: #fef3c7; border-radius: 5px;"><strong>Note:</strong> ${bankDetails.additionalInfo}</p>` : ''}
              </div>

              <div style="background: #fef3c7; padding: 15px 20px; border-left: 4px solid #f59e0b; border-radius: 5px; margin: 20px 0;">
                <p style="margin: 0;"><strong>⏰ Important:</strong> Please complete your payment within 24 hours to secure your reservation. Unpaid bookings may be cancelled automatically.</p>
              </div>
    ...
    `,
    text: `
Bank Transfer Details - Complete Your Payment

Dear ${booking.userName},

Thank you for choosing bank transfer as your payment method. Please find below our bank details to complete your payment.
...
${bankDetails.branchCode ? `- Branch Code: ${bankDetails.branchCode}\n` : ''}${bankDetails.swiftCode ? `- SWIFT Code: ${bankDetails.swiftCode}\n` : ''}

Payment Instructions:
1. Transfer exactly $${booking.totalPrice} to the account above
2. Use your Booking ID: ${booking._id} as the payment reference
3. Keep your payment receipt/proof of transfer
4. Send the payment receipt to payments@nonsatravels.com
5. Your booking will be confirmed within 24 hours after payment verification

${bankDetails.additionalInfo ? `Note: ${bankDetails.additionalInfo}\n\n` : ''}Important: Please complete your payment within 24 hours to secure your reservation.
